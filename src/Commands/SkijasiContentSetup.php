...
class SkijasiContentSetup extends Command
{
    private $force;
    /**
     ...
     * @var string
     */
    protected $signature = 'skijasi-content:setup {--force=false}';
    ...
    {
        $table_name = 'content';
        $config_name_file = 'skijasi-hidden-tables';
