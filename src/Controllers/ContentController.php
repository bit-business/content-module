...
namespace NadzorServera\Skijasi\Module\Content\Controllers;
...
class ContentController extends Controller
{
    ...
    public function read(Request $request)
    {
        try {
            $request->validate([
                'id' => 'required|string|exists:NadzorServera\Skijasi\Module\Content\Models\Content',
            ]);
    ...
    public function fetch(Request $request)
    {
        try {
            $request->validate([
                'slug' => 'required|string|exists:NadzorServera\Skijasi\Module\Content\Models\Content',
            ]);
    ...
    public function add(Request $request)
    {
        ...
        try {
            $request->validate([
                'slug'  => 'required|string|unique:NadzorServera\Skijasi\Module\Content\Models\Content',
    ...
    public function edit(Request $request)
    {
        ...
        try {
            $request->validate([
                'id'    => 'required|exists:NadzorServera\Skijasi\Module\Content\Models\Content',
                'slug'  => 'required|string|exists:NadzorServera\Skijasi\Module\Content\Models\Content',
                'label' => 'required|string',
                'value' => 'required',
            ]);
    ...
    public function fill(Request $request)
    {
        ...
        try {
            $request->validate([
                'id'    => 'required|exists:NadzorServera\Skijasi\Module\Content\Models\Content,id',
                'slug'  => 'required|string|exists:NadzorServera\Skijasi\Module\Content\Models\Content,slug',
                'label' => 'required|string',
                'value' => 'required',
            ]);
